package javaunit.adactin;
	...
	public class BaseClass2 {
		...
		TakesScreenshot screenShot;
		 ...
		 String data;
		  String path = "C:\\Users\\Ch Dharma\\eclipse-workspace\\MavenExcelSheet\\Excel\\ExcelCreate3.xlsx";

			public String getData(String sheetName,int rowNum ,int cellNum, String path) throws IOException {
	...
	public void WriteData(String sheetName,int rowNum, int cellNum, String data) throws IOException {
		...
		public void clear(WebElement element) {
			element.clear();                        //clear the data of particular one
		}
		...
		public static void manageWin() {
			driver.manage().window().maximize();
	 
		}
		
//		public static void textSend(WebElement element, String data) {
//			element.sendKeys(data);                            //sendkeys using static method
//
//		}
		
		public void textSend(WebElement element, String data) {
			clear(element);                                        //sendkeys using clear
		...
		public String getCurrentUrl() {               //11.get current url
